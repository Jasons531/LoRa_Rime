 ...
 * Radio driver functions implementation
 */
void SX1276ResetInit( RadioEvents_t *events )
{
    uint8_t i;
		RadioEvents = events;
...
uint32_t SX1276GetTimeOnAir( RadioModems_t modem, uint8_t pktLen )
{
    ...
    case MODEM_LORA:
        {
//            if(Set_air_time == false) ///第一次上电设置发送数据参数，获取空速
//            {
//                SX1276.Settings.LoRa.Bandwidth = 7;
//                switch(Sx127xHandle.UpdateAdr)
//                {
//                    case 0 : SX1276.Settings.LoRa.Datarate = 12;
//                            break;
//                    
//                    case 1 : SX1276.Settings.LoRa.Datarate = 11;
//                            break;
//                    
//                    case 2 : SX1276.Settings.LoRa.Datarate = 10;
//                            break;
//                    
//                    case 3 : SX1276.Settings.LoRa.Datarate = 9;
//                            break;
//                    
//                    case 4 : SX1276.Settings.LoRa.Datarate = 8;
//                            break;
//                    
//                    case 5 : SX1276.Settings.LoRa.Datarate = 7;
//                            break;
//                    
//                    default: break;
//                }						
//                
//                if(SX1276.Settings.LoRa.Datarate>20)
//                SX1276.Settings.LoRa.PreambleLen = 20;
//                else
...
//            }
//            
//            DEBUG_APP(3,"data = %d loradata = %d",SX1276.Settings.LoRa.Datarate,SX1276.Settings.LoRa.Datarate);
            double bw = 0.0;
...
void SX1276SetRx( uint32_t timeout )
{
    ...
    DEBUG_APP(2,"SX1276.Settings.State = RF_RX_RUNNING %d",timeout);
    if( timeout != 0 )
    {
...
int16_t SX1276ReadRssi( RadioModems_t modem )
{
    ...
    case MODEM_LORA:
        ...
        else
        {
            ...
            DEBUG_APP(2, "rssi : %d",SX1276Read( REG_LR_RSSIVALUE ));
        }
        break;
    default:
        rssi = -1;
...
//                TimerStop( &RxTimeoutSyncWord );
    ...
    case RF_TX_RUNNING:
        ...
        if( ( RadioEvents != NULL ) && ( RadioEvents->TxTimeout != NULL ) )
        {
            ...
            DEBUG_APP(2,"Txtimeout LoRa Hardware abnormal\r\n");
        }
        break;
    default:
        break;
...
//                    DEBUG(2,"RssiValue: %d time : %d\r\n",SX1276.Settings.LoRaPacketHandler.RssiValue, HAL_GetTick( )-rx1time);
//                    rx1time =  HAL_GetTick( );
...
//                    LoRapp_SenSor_States.loramac_evt_flag = 1;
//                    RFTXDONE(  );
//                    DEBUG(2,"TxDone LoRapp_SenSor_States.loramac_evt_flag : %d\r\n",LoRapp_SenSor_States.loramac_evt_flag);
                } 
                break;
            }
            break;
